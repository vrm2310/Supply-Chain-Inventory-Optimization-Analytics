...
SELECT product_name, category_name, total_sales, total_profit, avg_margin_pct, avg_discount_pct, total_orders, total_quantity, revenue_share_pct, cumulative_revenue_pct, revenue_rank, profit_rank, abc_class, product_velocity, inventory_priority FROM dim_products;
...
DROP VIEW IF EXISTS vw_logistics_performance;
...
DROP VIEW IF EXISTS vw_profitability_analysis;
